            ...
            lines: [
                {
                    ...
                    accentCold: "#d7ecff",
                    rows: [["素胚", "勾勒", "出"], ["青花", "笔锋", "浓转淡"]],
                    durations: [0.42, 0.46, 0.2, 0.42, 0.5, 0.58],
                },
                {
                    accent: "#8fd6ff",
                    accentSoft: "rgba(143, 214, 255, 0.22)",
                    accentCold: "#f6fbff",
                    rows: [["瓶身", "描绘", "的"], ["牡丹", "一如", "你", "初妆"]],
                    durations: [0.46, 0.42, 0.18, 0.42, 0.48, 0.22, 0.54],
                },
                {
                    accent: "#c2b0ff",
                    accentSoft: "rgba(194, 176, 255, 0.2)",
                    accentCold: "#8fd6ff",
                    rows: [["冉冉", "檀香", "透过"], ["窗", "心事", "我", "了然"]],
                    durations: [0.44, 0.44, 0.48, 0.28, 0.46, 0.2, 0.5],
                },
                {
                    accent: "#7ba6ff",
                    accentSoft: "rgba(123, 166, 255, 0.24)",
                    accentCold: "#f7f7ff",
                    rows: [["宣纸", "上", "走笔"], ["至", "此", "搁一半"]],
                    durations: [0.42, 0.2, 0.46, 0.18, 0.28, 0.54],
                },
            ],
        },
    };
